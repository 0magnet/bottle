...
// sinkFunc adapts an io.Writer to proc.js's stdout/stderr callback, which is
...
// sourceFunc adapts an io.Reader to proc.js's stdin puller, which expects a
// Uint8Array chunk per call (empty = nothing yet, null = EOF).
